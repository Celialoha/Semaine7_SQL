drop database CINEMA_MTP;
create database if not exists CINEMA_MTP;
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/CinemaMTP/film.csv' 
INTO TABLE film
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/CinemaMTP/salle.csv' 
INTO TABLE salle
FIELDS TERMINATED BY ';' 
ENCLOSED BY ''
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/CinemaMTP/programme.csv' 
